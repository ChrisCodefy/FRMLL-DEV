...
(T4stt_var = { HoverInterval: 35, HoverTimeout: 150, dragThreshold: 10, prevOnHref: !1 }),
    (function (t, e) {
        ...
        function m(t, e, i, n) {
            ...
            if (c && c[3] !== u) {
                for (l /= 2, u = u || c[3], c = +l || 1; r--; ) pt.style(t, e, c + u), (1 - s) * (1 - (s = a() / l || 0.5)) <= 0 && (r = 0), (c /= s);
        ...
        function x(t, e, i, o, s) {
            ...
            for (d.textContent = "", p = 0; (r = f[p++]); )
                ...
                else if (((c = qt(r)), (a = y(d.appendChild(r), "script")), c && b(a), i)) for (h = 0; (r = a[h++]); ) Gt.test(r.type || "") && i.push(r);
            return d;
        }
        function S() {
            return !0;
                    ...
                    for (c = a[a.length - 1].ownerDocument, pt.map(a, I), h = 0; h < l; h++)
                        (u = a[h]),
                            Gt.test(u.type || "") &&
                                ...
                                pt.contains(c, u) &&
                                (u.src && "module" !== (u.type || "").toLowerCase() ? pt._evalUrl && !u.noModule && pt._evalUrl(u.src, { nonce: u.nonce || u.getAttribute("nonce") }, c) : i(u.textContent.replace(Zt, ""), u, c));
            }
            return t;
        }
        function A(t, e, i) {
                            ...
                            (n = t[e]),
                                "__proto__" !== e &&
                                    ...
                                    (u && n && (pt.isPlainObject(n) || (o = Array.isArray(n)))
                                        ? ((i = r[e]), (s = o && !Array.isArray(i) ? [] : o || pt.isPlainObject(i) ? i : {}), (o = !1), (r[e] = pt.extend(u, s, n)))
                                        : void 0 !== n && (r[e] = n));
                return r;
            }),
            pt.extend({
                ...
                if (!n && (D(e), (e = e || A), z)) {
                    ...
                    if (x.qsa && !U[t + " "] && (!N || !N.test(t)) && (1 !== p || "object" !== e.nodeName.toLowerCase())) {
                        if (((c = t), (d = e), 1 === p && (ut.test(t) || lt.test(t)))) {
                            for (((d = (yt.test(t) && h(e.parentNode)) || e) === e && x.scope) || ((a = e.getAttribute("id")) ? (a = a.replace(St, wt)) : e.setAttribute("id", (a = O))), s = (u = C(t)).length; s--; )
                                u[s] = (a ? "#" + a : ":scope") + " " + f(u[s]);
                            c = u.join(",");
                        }
                        try {
                ...
                preFilter: {
                    ...
                    PSEUDO: function (t) {
                        ...
                        return dt.CHILD.test(t[0])
                            ? null
                            : (t[3] ? (t[2] = t[4] || t[5] || "") : i && ct.test(i) && (e = C(i, !0)) && (e = i.indexOf(")", i.length - e) - i.length) && ((t[0] = t[0].slice(0, e)), (t[2] = i.slice(0, e))), t.slice(0, 3));
                    },
                },
                filter: {
                    TAG: function (t) {
                            ...
                            : function (e, i, l) {
                                  ...
                                  if (m) {
                                      ...
                                      if (((p = [r ? m.firstChild : m.lastChild]), r && y)) {
                                          for (
                                              b = (f = (u = (c = (h = (d = m)[O] || (d[O] = {}))[d.uniqueID] || (h[d.uniqueID] = {}))[t] || [])[0] === $ && u[1]) && u[2], d = f && m.childNodes[f];
                                          ...
                                          for (
                                              ;
                                              (d = (++f && d && d[g]) || (b = f = 0) || p.pop()) &&
                                              ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++b || (y && ((c = (h = d[O] || (d[O] = {}))[d.uniqueID] || (h[d.uniqueID] = {}))[t] = [$, b]), d !== e));
            ...
            return (
                ...
                (C = e.tokenize = function (t, i) {
                    ...
                    for (a = t, l = [], u = S.preFilter; a; ) {
                        ...
                        S.filter))
                            !(o = dt[r].exec(a)) || (u[r] && !(o = u[r](o))) || ((n = o.shift()), s.push({ value: n, type: r, matches: o }), (a = a.slice(n.length)));
                        if (!n) break;
                    }
                                                    ...
                                                    (h = t && ("object" == typeof t || "function" == typeof t) && t.then),
                                                        ut(h)
                                                            ? o
                                                                ...
                                                                : (r++, h.call(t, s(r, i, l, o), s(r, i, u, o), s(r, i, l, i.notifyWith)))
                                                            : (n !== l && ((a = void 0), (c = [t])), (o || i.resolveWith)(a, c));
                                                }
                                            },
                                            d = o
                                                ? h
                    ...
                    for (
                        ...
                        (f = g = (a = Qt.exec(e[u]) || [])[1]),
                            ...
                            f &&
                                ...
                                (h = pt.event.special[f] || {}),
                                (c = pt.extend({ type: f, origType: g, data: n, handler: i, guid: i.guid, selector: o, needsContext: o && pt.expr.match.needsContext.test(o), namespace: p.join(".") }, s)),
            ...
            clone: function (t, e, i) {
                ...
                if (!(lt.noCloneChecked || (1 !== t.nodeType && 11 !== t.nodeType) || pt.isXMLDoc(t)))
                    for (r = y(c), n = 0, o = (s = y(t)).length; n < o; n++)
                        (a = s[n]), (l = r[n]), "input" === (u = l.nodeName.toLowerCase()) && Ut.test(a.type) ? (l.checked = a.checked) : ("input" !== u && "textarea" !== u) || (l.defaultValue = a.defaultValue);
                if (e)
                ...
                function (t, e, i) {
                    ...
                    if ((l = !pt.isEmptyObject(e)) || !pt.isEmptyObject(f))
                        for (n in (h &&
                            ...
                            "none" === (c = pt.css(t, "display")) && (u ? (c = u) : (v([t], !0), (u = t.style.display || u), (c = pt.css(t, "display")), v([t]))),
                ...
                if (
                    ...
                    for (s = 0; (r = f[s++]) && !e.isPropagationStopped(); )
                        (d = r),
                            ...
                            (c = (At.get(r, "events") || Object.create(null))[e.type] && At.get(r, "handle")) && c.apply(r, i),
                            (c = u && r[u]) && c.apply && Dt(r) && ((e.result = c.apply(r, i)), !1 === e.result && e.preventDefault());
                    return (
                        (e.type = p),
                        o ||
                ...
                ajax: function (e, i) {
                    function n(e, i, n, a) {
                        ...
                        c ||
                            ...
                            !u && -1 < pt.inArray("script", p.dataTypes) && pt.inArray("json", p.dataTypes) < 0 && (p.converters["text script"] = function () {}),
                            (x = (function (t, e, i, n) {
                                var o,
                                    s,
                                    r,
                            ...
                            u
                                ? (p.ifModified && ((S = T.getResponseHeader("Last-Modified")) && (pt.lastModified[s] = S), (S = T.getResponseHeader("etag")) && (pt.etag[s] = S)),
                                  204 === e || "HEAD" === p.type ? (w = "nocontent") : 304 === e ? (w = "notmodified") : ((w = x.state), (d = x.data), (u = !(f = x.error))))
                    ...
                    p.hasContent
                        ...
                        : ((f = p.url.slice(s.length)),
                          p.data && (p.processData || "string" == typeof p.data) && ((s += (Ee.test(s) ? "&" : "?") + p.data), delete p.data),
                          !1 === p.cache && ((s = s.replace(ze, "$1")), (f = (Ee.test(s) ? "&" : "?") + "_=" + _e.guid++ + f)),
                          (p.url = s + f)),
            ...
            pt.ajaxPrefilter("json jsonp", function (e, i, n) {
                ...
                if (a || "jsonp" === e.dataTypes[0])
                    return (
                        ...
                        a ? (e[a] = e[a].replace(Ue, "$1" + o)) : !1 !== e.jsonp && (e.url += (Ee.test(e.url) ? "&" : "?") + e.jsonp + "=" + o),
                ...
                i.width() < 1025 && d && (this.args.thumbVertical = !1),
                    i.on(
                        ...
                        T4SThemeSP.debounce(
                            300,
                            function () {
                                c.hasMWLG && (c.args.minWidthLG <= i.width() ? (c.flkty.options.cellAlign = c.args.cellAlignLG) : (c.flkty.options.cellAlign = c.args.cellAlignOriginnal)),
                                    c.actionsAPI("resize"),
                                    i.width() < 1025 && d ? (c.args.thumbVertical = !1) : i.width() > 1024 && d && (c.args.thumbVertical = !0);
                            }.bind(this)
                        )
                    ),
